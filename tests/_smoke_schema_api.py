...
from lakelogic import validate_contract, contract_schema, contract_schema_json, ValidationResult
...
r = ok("8", validate_contract(json.dumps({
    "version": "1.0",
...
print(f"[11] OK  ValidationResult serialisation")

# ── Test 12: top-level import symbols ─────────────────────────────────────────
from lakelogic import validate_contract, contract_schema, contract_schema_json, ValidationResult, ValidationError
