...
- **scaffold**: Job-safe pip install in fabric notebooks (%pip cancels Fabric job-run sessions)
## [1.43.0] — 2026-08-13
...
<!-- Link definitions -->
[1.43.1]: https://github.com/lakelogic/LakeLogic/compare/v1.43.0...v1.43.1
