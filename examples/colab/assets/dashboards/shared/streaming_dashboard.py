...
def create_streaming_dashboard_inline(
    ...
    **kwargs,
    ...
    header = pn.Row(
        pn.pane.Markdown("# 🚓 RideFlow Observatory", styles={"margin-top": "15px", "white-space": "nowrap", "min-width": "max-content"}),
        pn.layout.HSpacer(),
    ...
    card_trips = pn.Card(chart_trips, title="📈 Trip Volume Timeline", styles=CARD_STYLE, hide_header=False, sizing_mode="stretch_both", margin=10)
    card_top_drivers = pn.Card(chart_top_drivers, title="⭐ Top 10 Drivers", styles=CARD_STYLE, hide_header=False, sizing_mode="stretch_both", margin=10)
    
    card_city = pn.Card(chart_city, title="🏙️ Revenue by City", styles=CARD_STYLE, hide_header=False, sizing_mode="stretch_both", margin=10)
    card_ratings = pn.Card(chart_ratings, title="👍 Driver Quality Distribution", styles=CARD_STYLE, hide_header=False, sizing_mode="stretch_both", margin=10)
    card_surge = pn.Card(chart_surge, title="⚡ Surge Multiplier Profile", styles=CARD_STYLE, hide_header=False, sizing_mode="stretch_both", margin=10)
