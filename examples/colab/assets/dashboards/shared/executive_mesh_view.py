...
def create_executive_view():
    ...
    kpi_cards = pn.Row(
        pn.pane.HTML(card_style.format(title="GMV Today", value="2.4M £", color="#2ecc71"), sizing_mode="stretch_width"),
        pn.pane.HTML(card_style.format(title="Active Riders", value="48,200", color="#3498db"), sizing_mode="stretch_width"),
        pn.pane.HTML(card_style.format(title="Active Drivers", value="12,100", color="#e67e22"), sizing_mode="stretch_width"),
    ...
    health_data = [
        {"Pipeline Area": "Trips", "Status": "✅ GREEN", "Freshness": "< 2 min", "Quality": "99.8%", "Quarantine": "0.2%"},
        {"Pipeline Area": "Riders", "Status": "✅ GREEN", "Freshness": "< 5 min", "Quality": "99.1%", "Quarantine": "0.9%"},
        {"Pipeline Area": "Drivers", "Status": "✅ GREEN", "Freshness": "< 5 min", "Quality": "98.5%", "Quarantine": "1.5%"},
        {"Pipeline Area": "Telemetry", "Status": "⚠️ AMBER", "Freshness": "22 min", "Quality": "94.2%", "Quarantine": "5.8%"},
    ]
    ...
    body = pn.Column(
        ...
        pn.Row(
            ...
            pn.Column(pn.pane.Markdown("### 💰 Financials & Compute", margin=(20, 0, 0, 0)), cost_table, sizing_mode="stretch_width")
        ),
