"""
Wikimedia Recent Changes Stream Example

This example demonstrates real-time streaming from Wikimedia's Recent Changes feed.

Features:
- Real-time Wikipedia edits
- No API key required
- ~5-10 events/second
- Perfect for testing streaming pipelines
...
def main():
    """
    Simple Wikimedia streaming example.
    
    This connects to the Wikimedia Recent Changes stream and prints
    events in real-time.
    """
    
    print("=" * 80)
    print("Wikimedia Recent Changes Stream")
    print("=" * 80)
    print()
